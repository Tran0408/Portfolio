...
export const SkillsInfo = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: 'Qlik Sense',
        logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_vZyEusHPfvXSFX0xREs49pbX5GqTYU5fD3_q1YV8KmxJVpE7Tazm04OdQFYhpU7-2Y0&usqp=CAU',
      },
      {
        name: 'Excel',
        logo: 'https://img.icons8.com/?size=100&id=13654&format=png&color=000000',
      },
      {
        name: 'Pandas',
      ...
      {
        name: 'Neo4j',
        logo: 'https://static.cdnlogo.com/logos/n/36/neo4j_800.png',
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: 'GitHub',
        logo: 'https://img.icons8.com/?size=100&id=bVGqATNwfhYq&format=png&color=000000',
      ...
      {
        name: 'Vercel',
        logo: 'https://img.icons8.com/?size=100&id=LZKTTiYmHpgq&format=png&color=000000',
      },
      {
        name: 'Netlify',
...
export const experiences = [
  {
    id: 0,
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/ZS_Associates.svg/1200px-ZS_Associates.svg.png",
    role: "Business Technology Solutions Associate",
    company: "ZS Associates",
    date: "Sep 2022 - Jan 2024",
    desc: "Engineered PySpark/Databricks ingestion and transformation pipelines combining production, finance and field data into analytics-ready models. Built Python/REST services powering BI dashboards with auth, caching, validation and unit/integration tests. Designed and tuned SQL schemas, views and queries, added data-quality checks and SLA monitoring, and worked in Agile sprints with analytics/product teams to deliver maintainable pipelines and APIs.",
    skills: [
      "PySpark",
      "Databricks",
      "Python",
...
export const education = [
  {
    id: 0,
    img: "https://icon2.cleanpng.com/20180618/rjy/aa6n6uqv6.webp", // Master's logo
    school: "The University of Sydney",
    date: "Feb 2024 – Nov 2025",
    grade: "In progress",
    desc: "MCS candidate focusing on software engineering, data engineering and AI-driven systems. Building production-ready backend services, data pipelines and ML/LLM-powered applications alongside coursework in algorithms, distributed systems and data management.",
    degree: "Master of Computer Science",
  },
  {
    id: 1,
    img: "https://upload.wikimedia.org/wikipedia/en/thumb/b/b8/GGSIU_logo.svg/1200px-GGSIU_logo.svg.png", // Bachelor's logo
    school: "Guru Gobind Singh Indraprastha University",
    date: "Aug 2018 – Jun 2022",
    grade: "GPA: 8.77 / 10",
    desc: "Completed a B.Tech in Computer Science with strong foundations in data structures, algorithms, databases, operating systems and web technologies. Worked on academic and personal projects that sparked a deeper interest in backend engineering and data-intensive applications.",
